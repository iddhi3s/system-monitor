...
import { useGetMachines } from "../services/useGetMachines";

const Machines = () => {
    const { data, isLoading, isError } = useGetMachines();
    const navigate = useNavigate();

    return (
        <div className="w-full h-screen p-4 flex flex-col gap-8">
            <div className="bg-white p-6 shadow-lg rounded-2xl overflow-hidden">
